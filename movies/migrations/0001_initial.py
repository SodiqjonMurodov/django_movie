    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('premiere_date', models.DateField(default=datetime.date.today, verbose_name='Дата премьеры')),
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='Цена указана в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='Цена указана в долларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='Цена указана в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('directors', models.ManyToManyField(limit_choices_to={'director': True}, related_name='film_director', to='movies.actor', verbose_name='режиссер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(blank=True, help_text='Владелец ответа на комментарий', null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.comments', verbose_name='Получатель')),
